          ...
          {isEdit ? (
            <div className="flex flex-col gap-2">
              <input
                ...
                className="bg-gray-50 px-2 py-1 rounded outline-none"
        ...
        <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700">
          ...
          {isEdit ? (
            <select
              ...
              className="max-w-20 bg-gray-100 px-2 py-1 rounded outline-none"
            >
          ...
          {isEdit ? (
            <input
              ...
              className="max-w-28 bg-gray-100 px-2 py-1 rounded outline-none"
            />
          ) : (
